...
double bsgamma_Ecut(double C0[], double C1[], double C2[], double Cp[], double mu, double mu_W, double E0, struct parameters* param)
...
/* E0: cut on the photon energy */
{
	...
	double z=pow(running_mass(param->mass_c,param->mass_c,2.,param->mass_top_pole,param->mass_b,param)/mb,2.); 
...
/* --------------------------------------------- */
	...
	double P_em=1./param->inv_alpha_em*(2.*Cem[7]*C0[7]-C0[7]*C0[7]*2.*alphas_mu*log(param->mass_W/mu)/pi)/alphas_mu;
