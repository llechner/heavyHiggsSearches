...
/* initializes the "param" structure by initializing the parameters with either 0 or a value from the PDG2012 */
{
	int ie,je;
	...
	param->f_K=0.156;
	param->fK_fpi=1.193;
	param->f_Kstar_par=0.216;
	param->f_Kstar_perp=0.163;
	param->f_phi_par=0.235;
