...
{	
	...
	double P_p=1.-q2/pow(mB+0.04578,2.);

	double P_T=1.-q2/pow(mB+0.052,2.);

	double f0=a00+a10*z_q2+a20*pow(z_q2,2.)+a30*pow(z_q2,3.);
	double fp=(1./P_p)*(a0p+a1p*z_q2+a2p*pow(z_q2,2.)+(-a1p/3.+2.*a2p/3.)*pow(z_q2,3.));
	double fT=(1./P_T)*(a0T+a1T*z_q2+a2T*pow(z_q2,2.)+(-a1T/3.+2.*a2T/3.)*pow(z_q2,3.));
...
{
	double C0bmu[11],C1bmu[11],C2bmu[11],C0wmu[11],C1wmu[11],C2wmu[11],Cpbmu[11];
	double complex CQ0bmu[3],CQ1bmu[3],CQpbmu[3];
	double C0be[11],C1be[11],C2be[11],C0we[11],C1we[11],C2we[11],Cpbe[11];
	double complex CQ0be[3],CQ1be[3],CQpbe[3];
	struct parameters param;
