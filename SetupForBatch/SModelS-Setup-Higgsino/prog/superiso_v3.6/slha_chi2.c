...
int main(int argc,char** argv)
{
	...
	double C0eb[11],C1eb[11],C0ew[11],C1ew[11],C2ew[11],C2eb[11],Cpeb[11];
	double complex CQpeb[3],CQ0eb[3],CQ1eb[3];
	...
	int likelihood=1; /* 0 = LHCb method of moments / 1 = LHCb likelihood fit for B -> K* mu+ mu- observables */
...
//	names[ie++]="Bsee_untag                  ";
	...
	values[ie]=Bdmumu(C0b,C1b,C2b,CQ0b,CQ1b,&param,mu_b);
	names[ie++]="Bdmumu                      ";
...
//	values[ie]=BRBXsll(2,0.04/param.mass_b_1S/param.mass_b_1S,0.999,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,&param,mu_b);
...
//	values[ie]=BRBXsll(1,0.04/param.mass_b_1S/param.mass_b_1S,0.999,C0eb,C1eb,C2eb,CQ0eb,CQ1eb,Cpeb,CQpeb,&param,mu_b);
// 	names[ie++]="BRBXsee_full                ";

	values[ie]=BRBKstarll(2,0,0.1,2.,obsKstar,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,&param,mu_b)/(2.-0.1);
 	names[ie++]="dG_B0Kstar0mumu_0.1-2       ";
	values[ie]=BRBKstarll(2,0,2.,4.3,obsKstar,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,&param,mu_b)/(4.3-2.);
 	names[ie++]="dG_B0Kstar0mumu_2-4.3       ";
	values[ie]=BRBKstarll(2,0,4.3,8.68,obsKstar,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,&param,mu_b)/(8.68-4.3);
 	names[ie++]="dG_B0Kstar0mumu_4.3-8.68    ";
	values[ie]=BRBKstarll(2,0,14.18,16.,obsKstar,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,&param,mu_b)/(16.-14.18);
 	names[ie++]="dG_B0Kstar0mumu_14.18-16    ";
	values[ie]=BRBKstarll(2,0,16.,19.,obsKstar,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,&param,mu_b)/(19.-16.);
 	names[ie++]="dG_B0Kstar0mumu_16-19       ";
...
/*	values[ie]=BRBsphill(2,15.,pow(param.m_Bs-param.m_phi,2.)*0.999,obsphi,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,&param,mu_b)/(pow(param.m_Bs-param.m_phi,2.)*0.999-15.);
	...
	for(ie=0;ie<nmax;ie++) printf("%d\t%s:\t %.3e\n",ie,names[ie],values[ie]);
		
	printf("chi2 = %f\n",chi2(likelihood,names,values,nmax,&param,1)); /* 1 = compute the inverse covariance matrix - needed the first time chi2 is computed, then can be set to 0 */
