...
{
	double dC7[3],dC8[3],dC9[3],dC10[3];
	double dC7p[3],dC8p[3],dC9p[3],dC10p[3];
	double Q;
}
flhaparam;
...
int invert_matrix(int n, double in[n][n], double out[n][n]);
...
void CW_calculator(int gen, double C0w[], double C1w[], double C2w[], double mu_W, struct parameters* param); 
...
void Cprime_calculator(int gen, double Cpb[], double complex CQpb[], double mu_W, double mu, struct parameters* param);
...
double bsgamma_Ecut(double C0[], double C1[], double C2[], double Cp[], double mu, double mu_W, double ETcut, struct parameters* param);
...
double delta0(double C0[],double C0_spec[],double C1[],double C1_spec[],double Cp[],struct parameters* param,double mub,double muspec, double lambda_h);
...
/* bsmumu.c */
double Bsll(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[],struct parameters* param, double mu_b);
...
double Bsll_untag(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[],struct parameters* param, double mu_b);
...
double Bdll(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[],struct parameters* param, double mu_b);
...
double dBR_BXsll_dshat(int gen, double shat,  double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double dBR_BXsll_dshat_calculator(int gen, double shat, char name[]);
double BRBXsll(int gen, double smin, double smax, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBXsll_lowq2(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBXsll_highq2(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
...
double A_BXsll(int gen, double shat, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double A_BXsll_bin(int gen, double smin, double smax, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double A_BXsll_lowq2(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double A_BXsll_highq2(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double A_BXsmumu_lowq2_calculator(char name[]);
double A_BXsmumu_highq2_calculator(char name[]);
double A_BXsll_zero(int gen, double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
...
/* soft */
double dGamma_BKstarll_dq2_soft(int gen, int charge, double q2, double obs[][3], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double dGamma_BKstarll_dq2_soft_calculator(int gen, int charge, double q2, double obs[][3], char name[]);
double BRBKstarll_soft(int gen, int charge, double smin, double smax, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKstarll_lowq2_soft(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKstarll_highq2_soft(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
...
/* full */
double dGamma_BKstarll_dq2_full(int gen, int charge, double q2, double obs[][3], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double dGamma_BKstarll_dq2_full_calculator(int gen, int charge, double q2, double obs[][3], char name[]);
double BRBKstarll_full(int gen, int charge, double smin, double smax, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKstarll_lowq2_full(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKstarll_highq2_full(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
...
/* wrapper */
double dGamma_BKstarll_dq2(int gen, int charge, double q2, double obs[][3], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double dGamma_BKstarll_dq2_calculator(int gen, int charge, double q2, double obs[][3], char name[]);
double BRBKstarll(int gen, int charge, double smin, double smax, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKstarll_lowq2(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKstarll_highq2(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
...
/* bkll.c */
/* soft */
double dGamma_BKll_dq2_soft(int gen, int charge, double q2, double obs[][3], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double dGamma_BKll_dq2_soft_calculator(int gen, int charge, double q2, double obs[][3], char name[]);
double BRBKll_soft(int gen, int charge, double smin, double smax, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double RK_BKll_soft(int charge, double smin, double smax, double C0be[], double C1be[], double C2be[], double complex CQ0be[], double complex CQ1be[], double Cpbe[], double complex CQpbe[], double C0bmu[], double C1bmu[], double C2bmu[], double complex CQ0bmu[], double complex CQ1bmu[], double Cpbmu[], double complex CQpbmu[], struct parameters* param, double mu_b);
double BRBKll_lowq2_soft(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKll_highq2_soft(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
...
/* full */
double dGamma_BKll_dq2_full(int gen, int charge, double q2, double obs[][3], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double dGamma_BKll_dq2_full_calculator(int gen, int charge, double q2, double obs[][3], char name[]);
double BRBKll_full(int gen, int charge, double smin, double smax, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double RK_BKll_full(int charge, double smin, double smax, double C0be[], double C1be[], double C2be[], double complex CQ0be[], double complex CQ1be[], double Cpbe[], double complex CQpbe[], double C0bmu[], double C1bmu[], double C2bmu[], double complex CQ0bmu[], double complex CQ1bmu[], double Cpbmu[], double complex CQpbmu[], struct parameters* param, double mu_b);
double BRBKll_lowq2_full(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKll_highq2_full(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
...
/* wrapper */
double dGamma_BKll_dq2(int gen, int charge, double q2, double obs[][3], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double dGamma_BKll_dq2_calculator(int gen, int charge, double q2, double obs[][3], char name[]);
double BRBKll(int gen, int charge, double smin, double smax, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double RK_BKll(int charge, double smin, double smax, double C0be[], double C1be[], double C2be[], double complex CQ0be[], double complex CQ1be[], double Cpbe[], double complex CQpbe[], double C0bmu[], double C1bmu[], double C2bmu[], double complex CQ0bmu[], double complex CQ1bmu[], double Cpbmu[], double complex CQpbmu[], struct parameters* param, double mu_b);
double BRBKll_lowq2(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
double BRBKll_highq2(int gen, int charge, double obs[], double C0b[], double C1b[], double C2b[], double complex CQ0b[], double complex CQ1b[], double Cpb[], double complex CQpb[], struct parameters* param, double mu_b);
