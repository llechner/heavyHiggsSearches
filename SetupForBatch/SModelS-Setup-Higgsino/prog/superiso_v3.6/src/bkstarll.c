...
double dAI_BKstarmumu_dq2(double q2, double C0b[], double C1b[], double C2b[], struct parameters* param, double mu_b)
{
	...
	double V=P_V*(a0V+a1V*(z_q2tau0-z_0tau0)+a2V*(pow(z_q2tau0-z_0tau0,2.)));
	double A1=P_A1*(a0A1+a1A1*(z_q2tau0-z_0tau0)+a2A1*(pow(z_q2tau0-z_0tau0,2.)));
	double A12=P_A12*(a0A12+a1A12*(z_q2tau0-z_0tau0)+a2A12*(pow(z_q2tau0-z_0tau0,2.)));
...
{	
	...
	if(q2<14.)
	{
		...
		double complex Tauparpu_bar=param->Vus*conj(param->Vub)/param->Vts/conj(param->Vtb)*(xi_par*Cparpu+pi*pi/3.*param->f_B*f_Kstar_par/mB*Xi_par*int_parpu);
		...
		ALperp=N*sqrt(2.)*sqrt(lambda)*(((C9+C9p)-(C10+C10p))*V/(mB+mKstar)+2.*mb/q2*(Tauperpp+Tauperppu));
		ARperp=N*sqrt(2.)*sqrt(lambda)*(((C9+C9p)+(C10+C10p))*V/(mB+mKstar)+2.*mb/q2*(Tauperpp+Tauperppu));
		
		ALpar=-N*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9-C9p)-(C10-C10p))*((2.*E_Kstar/(mB+mKstar)*xi_perp))/(mB-mKstar)+4.*mb/mB*E_Kstar/q2*(Tauperpm+Tauperpmu));
		ARpar=-N*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9-C9p)+(C10-C10p))*((2.*E_Kstar/(mB+mKstar)*xi_perp))/(mB-mKstar)+4.*mb/mB*E_Kstar/q2*(Tauperpm+Tauperpmu));
	
		AL0=-N/2./mKstar/sqrt(q2)*(((C9-C9p)-(C10-C10p))*((mB*mB-mKstar*mKstar-q2)*(mB+mKstar)*((2.*E_Kstar/(mB+mKstar)*xi_perp))-lambda*((mB/(mB-mKstar)*(xi_perp-xi_par)))/(mB+mKstar))+2.*mb*(2.*E_Kstar/mB*(mB*mB+3.*mKstar*mKstar-q2)*(Tauperpm+Tauperpmu)-lambda/(mB*mB-mKstar*mKstar)*(Tauperpm+Tauparm+Tauperpmu+Tauparmu)));
		AR0=-N/2./mKstar/sqrt(q2)*(((C9-C9p)+(C10-C10p))*((mB*mB-mKstar*mKstar-q2)*(mB+mKstar)*((2.*E_Kstar/(mB+mKstar)*xi_perp))-lambda*((mB/(mB-mKstar)*(xi_perp-xi_par)))/(mB+mKstar))+2.*mb*(2.*E_Kstar/mB*(mB*mB+3.*mKstar*mKstar-q2)*(Tauperpm+Tauperpmu)-lambda/(mB*mB-mKstar*mKstar)*(Tauperpm+Tauparm+Tauperpmu+Tauparmu)));
		...
		ALperp_bar=Nbar*sqrt(2.)*sqrt(lambda)*(((C9+C9p)-(C10+C10p))*V/(mB+mKstar)+2.*mb/q2*(Tauperpp+Tauperppu_bar));
		ARperp_bar=Nbar*sqrt(2.)*sqrt(lambda)*(((C9+C9p)+(C10+C10p))*V/(mB+mKstar)+2.*mb/q2*(Tauperpp+Tauperppu_bar));
	
		ALpar_bar=-Nbar*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9-C9p)-(C10-C10p))*((2.*E_Kstar/(mB+mKstar)*xi_perp))/(mB-mKstar)+4.*mb/mB*E_Kstar/q2*(Tauperpm+Tauperpmu_bar));
		ARpar_bar=-Nbar*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9-C9p)+(C10-C10p))*((2.*E_Kstar/(mB+mKstar)*xi_perp))/(mB-mKstar)+4.*mb/mB*E_Kstar/q2*(Tauperpm+Tauperpmu_bar));
	
		AL0_bar=-Nbar/2./mKstar/sqrt(q2)*(((C9-C9p)-(C10-C10p))*((mB*mB-mKstar*mKstar-q2)*(mB+mKstar)*((2.*E_Kstar/(mB+mKstar)*xi_perp))-lambda*((mB/(mB-mKstar)*(xi_perp-xi_par)))/(mB+mKstar))+2.*mb*(2.*E_Kstar/mB*(mB*mB+3.*mKstar*mKstar-q2)*(Tauperpm+Tauperpmu_bar)-lambda/(mB*mB-mKstar*mKstar)*(Tauperpm+Tauparm+Tauperpmu_bar+Tauparmu_bar)));
		AR0_bar=-Nbar/2./mKstar/sqrt(q2)*(((C9-C9p)+(C10-C10p))*((mB*mB-mKstar*mKstar-q2)*(mB+mKstar)*((2.*E_Kstar/(mB+mKstar)*xi_perp))-lambda*((mB/(mB-mKstar)*(xi_perp-xi_par)))/(mB+mKstar))+2.*mb*(2.*E_Kstar/mB*(mB*mB+3.*mKstar*mKstar-q2)*(Tauperpm+Tauperpmu_bar)-lambda/(mB*mB-mKstar*mKstar)*(Tauperpm+Tauparm+Tauperpmu_bar+Tauparmu_bar)));
	...
	double AFB[3],FL[3],FT[3],AT1[3],AT2[3],AT3[3],AT4[3],AT5[3],HT1[3],HT2[3],HT3[3],alpha_Kstar[3],AIm[3],P2[3],P3[3],P6[3],P8[3],P4prime[3],P5prime[3],P6prime[3],P8prime[3],A7[3],A8[3],A9[3],S3[3],S4[3],S5[3],S6[3],S7[3],S8[3],S9[3];
...
{	
	...
	double A0=P_A0*(a0A0+a1A0*(z_q2tau0-z_0tau0)+a2A0*(pow(z_q2tau0-z_0tau0,2.)));
	double T1=P_T1*(a0T1+a1T1*(z_q2tau0-z_0tau0)+a2T1*(pow(z_q2tau0-z_0tau0,2.)));
	double T2=P_T2*(a0T2+a1T2*(z_q2tau0-z_0tau0)+a2T2*(pow(z_q2tau0-z_0tau0,2.)));
	double T23=P_T23*(a0T23+a1T23*(z_q2tau0-z_0tau0)+a2T23*(pow(z_q2tau0-z_0tau0,2.)));
	...
	if(q2<14.)
	{
		...
		ALperp=N*sqrt(2.)*sqrt(lambda)*(((C9+Y+C9p)-(C10+C10p))*V/(mB+mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff+C7effp)*T1)+sqrt(2.)*N*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*sqrt(lambda)*(Tauperpp+Tauperppu);
		
		ARperp=N*sqrt(2.)*sqrt(lambda)*(((C9+Y+C9p)+(C10+C10p))*V/(mB+mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff+C7effp)*T1)+sqrt(2.)*N*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*sqrt(lambda)*(Tauperpp+Tauperppu);
		
		ALpar=-N*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9+Y-C9p)-(C10-C10p))*A1/(mB-mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff-C7effp)*T2)-sqrt(2.)*N*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(mB*mB-mKstar*mKstar)*2.*E_Kstar/mB*(Tauperpm+Tauperpmu);
	
		ARpar=-N*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9+Y-C9p)+(C10-C10p))*A1/(mB-mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff-C7effp)*T2)-sqrt(2.)*N*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(mB*mB-mKstar*mKstar)*2.*E_Kstar/mB*(Tauperpm+Tauperpmu);
	
		AL0=-N/2./mKstar/sqrt(q2)*(((C9+Y-C9p)-(C10-C10p))*(16.*mB*mKstar*mKstar*A12)+2.*(mb+alphas_mub/3./pi*DeltaM)*(C7eff-C7effp)*(8.*mB*mKstar*mKstar/(mB+mKstar)*T23))-N*(mb+alphas_mub/3./pi*DeltaM)/mKstar/sqrt(q2)*((mB*mB+3.*mKstar*mKstar-q2)*2.*E_Kstar/mB-lambda/(mB*mB-mKstar*mKstar))*(Tauperpm+Tauperpmu)+N*(mb+alphas_mub/3./pi*DeltaM)/mKstar/sqrt(q2)*lambda/(mB*mB-mKstar*mKstar)*(Tauparm+Tauparmu);
		...
		ALperp_bar=Nbar*sqrt(2.)*sqrt(lambda)*(((C9+Y+C9p)-(C10+C10p))*V/(mB+mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff+C7effp)*T1)+sqrt(2.)*Nbar*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*sqrt(lambda)*(Tauperpp+Tauperppu_bar);
	
		ARperp_bar=Nbar*sqrt(2.)*sqrt(lambda)*(((C9+Y+C9p)+(C10+C10p))*V/(mB+mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff+C7effp)*T1)+sqrt(2.)*Nbar*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*sqrt(lambda)*(Tauperpp+Tauperppu_bar);
	
		ALpar_bar=-Nbar*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9+Y-C9p)-(C10-C10p))*A1/(mB-mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff-C7effp)*T2)-sqrt(2.)*Nbar*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(mB*mB-mKstar*mKstar)*2.*E_Kstar/mB*(Tauperpm+Tauperpmu_bar);
	
		ARpar_bar=-Nbar*sqrt(2.)*(mB*mB-mKstar*mKstar)*(((C9+Y-C9p)+(C10-C10p))*A1/(mB-mKstar)+2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(C7eff-C7effp)*T2)-sqrt(2.)*Nbar*2.*(mb+alphas_mub/3./pi*DeltaM)/q2*(mB*mB-mKstar*mKstar)*2.*E_Kstar/mB*(Tauperpm+Tauperpmu_bar);
	
		AL0_bar=-Nbar/2./mKstar/sqrt(q2)*(((C9+Y-C9p)-(C10-C10p))*(16.*mB*mKstar*mKstar*A12)+2.*(mb+alphas_mub/3./pi*DeltaM)*(C7eff-C7effp)*(8.*mB*mKstar*mKstar/(mB+mKstar)*T23))-Nbar*(mb+alphas_mub/3./pi*DeltaM)/mKstar/sqrt(q2)*((mB*mB+3.*mKstar*mKstar-q2)*2.*E_Kstar/mB-lambda/(mB*mB-mKstar*mKstar))*(Tauperpm+Tauperpmu_bar)+Nbar*(mb+alphas_mub/3./pi*DeltaM)/mKstar/sqrt(q2)*lambda/(mB*mB-mKstar*mKstar)*(Tauparm+Tauparmu_bar);

		AR0_bar=-Nbar/2./mKstar/sqrt(q2)*(((C9+Y-C9p)+(C10-C10p))*(16.*mB*mKstar*mKstar*A12)+2.*(mb+alphas_mub/3./pi*DeltaM)*(C7eff-C7effp)*(8.*mB*mKstar*mKstar/(mB+mKstar)*T23))-Nbar*(mb+alphas_mub/3./pi*DeltaM)/mKstar/sqrt(q2)*((mB*mB+3.*mKstar*mKstar-q2)*2.*E_Kstar/mB-lambda/(mB*mB-mKstar*mKstar))*(Tauperpm+Tauperpmu_bar)+Nbar*(mb+alphas_mub/3./pi*DeltaM)/mKstar/sqrt(q2)*lambda/(mB*mB-mKstar*mKstar)*(Tauparm+Tauparmu_bar);
