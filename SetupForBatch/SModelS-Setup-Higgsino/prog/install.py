...
def write_path_to_SusHi_makefile():
    ...
    path = os.path.abspath('../../../../prog/LHAPDF-6.1.6/installation/lib')
...
def install_superiso():
    os.system('echo install SuperISO')
    os.chdir('superiso_v3.6')
    os.system('make clean')
    os.system('make > /dev/null 2>&1')
    os.system('make slha > /dev/null 2>&1')
    os.chdir('..')
...
#    os.system('./configure --with-boost --prefix=$PWD/installation > /dev/null 2>&1')
...
def install_SModelS():
    ...
    os.system('make > /dev/null 2>&1')
    os.chdir('../../')
    os.system('python setup.py install --user > /dev/null 2>&1')
    os.chdir('..')
