...
path_output_SusHi = path_output + 'SusHi14/'					#path to saved SModelS output
file_output_SusHi = 'SusHi14.out'							#filename saved SusyHit output
file_output_SusHi_log = 'SusHi14_log.out'						#filename saved SusyHit log
file_input_SusHi = 'SusHi14.in'							#filename SusyHit input (unchangable)
...
path_output_SModelS_interHiggs = path_output + 'SModelS/nodatabase/' # 'SModelS/intermediateHiggs/'					#path to saved SModelS output
