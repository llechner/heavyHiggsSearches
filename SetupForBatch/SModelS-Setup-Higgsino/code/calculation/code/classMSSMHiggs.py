...
#            self.SusyHit() #calculate BR + mass spectrum
        ...
        if check_SModelS_direct:
            print('run SModelS direct search')
            try:
                ...
                if self.SModelSd.outputstatus != 0 and self.SModelSd.outputstatus != 1:
                    self.excluded_by[3] = '-1'
            except:
                print(sys.exc_info()[1])
                pass
        ...
        if check_SModelS_interHiggs:
            ...
            print('run SModelS intermediate Higgs search')
            try:
                ...
                self.missing_topologies = self.SModelSiH.missing_topo
                if self.SModelSiH.exclusion == 1:
                    self.valid = False    
                    self.excluded_by[4] = '1'
                else:
                    self.excluded_by[4] = '0'
                if self.SModelSiH.outputstatus != 0 and self.SModelSiH.outputstatus != 1:
                    self.excluded_by[4] = '-1'
            except:
                print(sys.exc_info()[1])
                pass
